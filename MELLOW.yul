...
object "MELLOW_1506" {
    ...
    object "MELLOW_1506_deployed" {
        code {
            ...
            if iszero(calldatasize()) { fun__1436() stop() }
            ...
            function fun_openTrading_1432_inner() {
                ...
                if iszero(_94) { revert_forward_1() }
                ...
                if iszero(_100) { revert_forward_1() }
            ...
            function fun_swapTokensForEth_1219_inner(var_tokenAmount_1159) {
                ...
                if iszero(_262) { revert_forward_1() }
                ...
                if iszero(extcodesize(expr_1206_address)) { revert_error_0cc013b6b3b6beabea4e3a74a6d380f0df81852ca99887912475e1f66b2a2c20() }
                ...
                if iszero(_273) { revert_forward_1() }
        ...
        data ".metadata" hex"a2646970667358221220535ca85a2ed366662727825f2d2bcaff2eb1c3c5f789d1457c905adc2a97da0264736f6c63782c302e382e32352d646576656c6f702e323032342e362e32352b636f6d6d69742e62363163326139312e6d6f64005d"
    }
